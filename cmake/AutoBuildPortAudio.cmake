...
# Usage:
# AutoBuild_use_package_PortAudio(
...
# )
#
macro(AutoBuild_use_package_PortAudio YOUR_TARGET INTERFACE_PUBLIC_OR_PRIVATE)
    set(PACKAGE_NAME "PortAudio")
    ...
    if ("${${PACKAGE_NAME}_FOUND}" OR "${${PACKAGE_NAME_UPPER}_FOUND}")
        ...
        target_link_libraries(${YOUR_TARGET} ${INTERFACE_PUBLIC_OR_PRIVATE} ${PORTAUDIO_LIBRARIES})
        target_include_directories(${YOUR_TARGET} ${INTERFACE_PUBLIC_OR_PRIVATE} ${PORTAUDIO_INCLUDE_DIR})
